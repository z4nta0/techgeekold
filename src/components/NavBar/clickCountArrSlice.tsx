...
/** Click Count Array Slice           = This stores the return of Redux Toolkit's core API that automatically generates action creators and reducers for a single slice of application's state. It returns a single object that contains the slice name, generated reducer, its corresponding actions, case reducers, and an optional getSelectors function. */
export const cliCouArrSlice           = createSlice( sliOptObj );
/** About and Contact Count Reducer   = This stores the reducer functions that were generated by the above {@link cliCouArrSlice} and that were defined in the {@link sliOptObj} object's reducers property. */
export const { aboCouRed, conCouRed } = cliCouArrSlice.actions;
/** Click Count Array Reducer         = This stores the parent reducer of this slice and will be what is exported into the store inside of src/store.tsx, and it is responsible for handling all actions defined within this specific slice of the Redux store's state. */
const cliCouArrReducer                = cliCouArrSlice.reducer;
/** Click Count Array Reducer         = This stores the type of this slice's parent reducer. Although this may seem redundant, exporting the type of the reducer can be useful for type checking and ensuring consistency across the application. */
export type CliCouArrReducer          = typeof cliCouArrReducer;
