...
/** IniStaNum - Initial State Number will store the initial value of the couStaNum variable {@link iniStaNum} in the {@link sliOptObj} object's initialState property. This will also be used in the {@link sliOptObj} object as the reducers functions' default value for the state parameter. */
...
/** This is Redux Toolkit's core API that automatically generates action creators and reducers for a single "slice" of application's state. It returns a single object that contains the slice name, generated reducer, its corresponding actions, case reducers, and an optional getSelectors function. */
export const couStaSli = createSlice( sliOptObj );

/** This exports the reducer functions that were generated by the above {@link couStaSli} and that were defined in the {@link sliOptObj} object's reducers property. */
export const { incNumRed, decNumRed } = couStaSli.actions;

// #endregion Slice Creation



/** This exports the reducer function that was generated by the above {@link couStaSli} and that was defined in the {@link sliOptObj} object's reducers property, and it is what will get imported into the Redux store inside of src/store.tsx. */
export default couStaSli.reducer;
