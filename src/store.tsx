...
import cliCouArrReducer from './components/NavBar/clickCountArrSlice.tsx'; /** This import is the custom reducer responsible for handling the state of the click count array for the About and Contact page links in the navigation bar component. */
import cliCouObjReducer from './components/NavBar/clickCountObjSlice.tsx'; /** This import is the custom reducer responsible for handling the state of the click count object for the logo and Home page links in the navigation bar component. */
import couStaNumReducer from './features/counterSlice.tsx';                /** This import is the custom reducer responsible for handling the state of the counter number for the counter feature in the Home page component. */
import mocDatJsoReducer from './api/dataSlice.tsx';                        /** This import is the custom reducer responsible for handling the mock (backend) data json that is show in the Home page compoenent. */
...
import { type CliCouArrReducer } from './components/NavBar/clickCountArrSlice.tsx'; /** This import is the custom type definition for the custom click count array reducer. */
import { type CliCouObjReducer } from './components/NavBar/clickCountObjSlice.tsx'; /** This import is the custom type definition for the custom click count object reducer. */
import { type CouStaNumReducer } from './features/counterSlice.tsx';                /** This import is the custom type definition for the custom click count object reducer. */
import { type MocDatJsoReducer } from './api/dataSlice.tsx';                        /** This import is the custom type definition for the custom mock (backend) data json reducer. */
